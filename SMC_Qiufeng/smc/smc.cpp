...
public:
  ...
  */
  ...
  /*
    ...
    For every CUDA kernel function call, it first records the name of the grid variable during the first traversal.
  ...
  void RewriteKernelCall(Stmt *s){
    ...
    */
	...
	if(traverseCount == 2){
      ...
      /*
	3rd time traversing, check if there is an integer grid variable. e.g. int numBlocks = 128;
      */
